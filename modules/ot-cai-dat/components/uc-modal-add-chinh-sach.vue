<template>
    <uc-form-modal v-model:isOpen="isOpen" ref="modalRef" title="Thêm chính sách" :formData="form" :rules="rules" :width="500" @onSubmit="onFinish()" :isSubmit="isLoading" @onClose="handleCancel()">
        <a-row :gutter="[10]">
            <a-col :span="24">
