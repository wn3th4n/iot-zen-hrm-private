		...
		<a-row :gutter="[10]">
			...
			<a-col :sm="12" :md="12">
				<a-form-item label="Ngày bắt đầu" name="NgayKetThuc">
					<a-date-picker format="DD/MM/YYYY" v-model:value="formData.NgayKetThuc" class="w-100" :allowClear="false">
					</a-date-picker>
				</a-form-item>
			</a-col>
			<a-col :sm="12" :md="12">
			...
			<a-col :sm="24" :md="24">
				<a-form-item label="Gửi thông báo cho nhân viên qua email" name="TrangThai_ThongBao">
