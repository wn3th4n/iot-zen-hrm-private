    ...
    data() {
        ...
        return {
            ...
            columnBangLuongVaPhucLoi: [
                ...
                { title: 'Mức lương lúc nhận tuyển', dataIndex: '', width: 200 },
                ...
                { title: 'Tên chủ tài khoản', dataIndex: 'TenTaiKhoan_NganHang', width: 150 },
                ...
                { title: 'Ngày nghỉ việc', dataIndex: 'NgayNghiViec', width: 150 },
                { title: 'Văn phòng', dataIndex: 'TenVanPhong', width: 200 },
                { title: 'Khu vực / Chuyên môn', dataIndex: 'TenKhuVucChuyenMon', width: 200 },
            ],
