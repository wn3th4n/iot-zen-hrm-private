<template>
    <uc-form-modal v-model:isOpen="isOpen" title="Thêm cột" :width="1400" :formData="formData" ref="modalRef" :rules="rules" :isLoading="isLoading" @onSubmit="onSubmit()" @onClose="handleCancel()">
        <a-row :gutter="[20]">
            <a-col :span="8">
...
export default {
    emits: ['onFinish'],
    props: ['isOpen', 'maubangluongid', 'DSBienHeThong'],
    data() {
        return {
            isLoading: false,
            formData: {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            $this.isLoading = true
            ajaxCALL(
                '/work/PA_MauBangLuong_ThuocTinh_Insert',
                {
