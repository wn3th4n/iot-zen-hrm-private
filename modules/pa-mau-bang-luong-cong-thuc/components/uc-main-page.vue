<template>
    <uc-layout>
        ...
        <a-table :columns="columns" :data-source="DSCauHinhCot" :pagination="false" size="small" :scroll="{ x: 300, y: 'calc(100vh - 96px)' }" class="ant-table-striped" :row-class-name="rowClassName">
        ...
        <uc-modal-add-cau-hinh-cot v-model:isOpen="modal.isShowModalAddCot" @onFinish="loadCauHinhCot()" :maubangluong="MauBangLuong_Item" :DSBienHeThong="DSBienHeThong" :maubangluongid="MauBangLuongID" />
        <uc-modal-edit-cau-hinh-cot :cauhinhcot="CauHinhCot_Item" v-model:isOpen="modal.isShowModalEditCot" @onFinish="loadCauHinhCot()" :maubangluong="MauBangLuong_Item" :DSBienHeThong="DSBienHeThong" />
    </uc-layout>
</template>
