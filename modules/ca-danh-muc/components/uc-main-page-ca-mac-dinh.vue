<template>
	<div>
		...
		<a-row>
			<a-col :span="5">
				<a-menu v-model:selectedKeys="MauBangCongId" class="scrollbar-thin" mode="vertical"
		...
		<uc-modal-add-ca-mac-dinh v-if="action.IsShowModalAdd" v-model:isOpen="action.IsShowModalAdd"
			@onFinish="loadCaMacDinh()" :maubangcongid="MauBangCongId" :dsnhomcamau="DSNhomCaMau" :dsvitri="DSViTri" />
		<uc-modal-edit-ca-mac-dinh v-if="action.IsShowModalEdit" v-model:isOpen="action.IsShowModalEdit"
			@onFinish="loadCaMacDinh()" :dsnhomcamau="DSNhomCaMau" :dsvitri="DSViTri" :maubangcongid="MauBangCongId"
			:record="recordItem" />
	</div>
</template>
