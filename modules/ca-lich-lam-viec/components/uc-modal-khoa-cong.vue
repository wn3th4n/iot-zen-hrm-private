<template>
    <uc-modal v-model:isOpen="isOpen" title="Khóa công" :width="500" @onClose="onCloseModal()" ref="refFormModal" @onSubmit="onSubmit()" okText="Khóa công">
            ...
            <a-row :gutter="[10]">
                ...
                <a-col :span="12">
                    <a-form-item label="Từ ngày">
                        <a-date-picker placeholder="Chọn ngày" format="DD/MM/YYYY" v-model:value="TuNgay" :disabled="cachTinh === 1" :disabledDate="disabledDate" :defaultPickerValue="defaultPickerValue" class="w-100" />
                    </a-form-item>
                </a-col>
                <a-col :span="12">
                    <a-form-item label="Đến ngày">
                        <a-date-picker placeholder="Chọn ngày" format="DD/MM/YYYY" v-model:value="DenNgay" :disabled="cachTinh === 1" :disabledDate="disabledDate" :defaultPickerValue="defaultPickerValue" class="w-100" />
                    </a-form-item>
                </a-col>
            </a-row>
        </a-form>
