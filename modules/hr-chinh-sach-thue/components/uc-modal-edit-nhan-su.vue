<template>
    <uc-form-modal title="Cập nhật chính sách cho nhân sự" :isOpen="isOpen" ref="modalRef" :width="450" :rules="rules" :formData="record" @onSubmit="onSubmit()" :isSubmit="state.isLoadingForm" @onClose="onClose()">
        <a-row :gutter="[10]">
            <a-col :span="24">
