<template>
	<a-modal v-model="action.isShowModalEditCot" title="Chỉnh sửa cấu hình cột" :width="1500" class="v-application">
...
<script>
	export default {
		props: ["action", "onCreateFinish", "cauhinhcot", "DSBienHeThong"],
		data() {
			return {
				loading: false,
				form_default: {
